...
public class withdraw {
    ...
    public withdraw(Stage stage, Account cust1) {
        this.stage = stage;
        this.cust1 =cust1;
    ...
    public void draw(){
        ...
        Text withdrawcomment = new Text();
        withdrawcomment.setFill(Color.WHITE);
        ...
        g.getChildren().add(withdrawField);
        ...
        g.getChildren().add(withdrawcomment);
                 
        withdrawField.setLayoutX(175);
        withdrawField.setLayoutY(97);
        ...
        withdrawcomment.setLayoutX(175);
        withdrawcomment.setLayoutY(90);
        num9.setLayoutX(280);
        num9.setLayoutY(135);
        num8.setLayoutX(240);
        num8.setLayoutY(135);
        ...
        num0.setLayoutY(225);
          ...
          num1.setOnAction(new EventHandler<ActionEvent>() {
           ...
           num2.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                if(withdrawField.getText()==null || withdrawField.getText().trim().isEmpty()){
                
                 withdrawcomment.setText("WARNING:please enter the withdraw amount!!");
                 
                }else{
                  withdrawAmount =Double.parseDouble(withdrawField.getText()) ;
                 if(withdrawAmount<=getCust1().getbalance()){
                        getCust1().withdraw(withdrawAmount);
                 withdrawcomment.setText("withdraw succeed!");
               
                 
                 }else{
                 withdrawcomment.setText("there's no sufficient balance");
                 }
                }
